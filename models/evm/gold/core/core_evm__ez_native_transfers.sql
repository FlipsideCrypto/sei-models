...
{% set GLOBAL_NEW_BUILD_ENABLED = var('GLOBAL_NEW_BUILD_ENABLED', false) %}
...
WITH base AS (
    ...
    FROM
        ...
        AND p0.token_address = '0xe30fedd158a2e3b13e9badaeabafc5516e95e8c7'
...
SELECT
    ...
    {% if is_incremental() or GLOBAL_NEW_BUILD_ENABLED %}
    SYSDATE() AS inserted_timestamp,
    SYSDATE() AS modified_timestamp
    {% else %}
...
WHERE
    ...
    AND t.block_timestamp :: DATE >= '2023-08-15'
